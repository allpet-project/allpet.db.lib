...
namespace AllpetDB
{
    ...
    class SnapShot : ISnapShot
    {
        ...
        public void Init()
        {
            ...
            var _height = GetValue(AllpetDB.systemtable_info, "_height".ToBytes_UTF8Encode());
            ...
            {
                this.DataHeight = GetValue(AllpetDB.systemtable_info, "_height".ToBytes_UTF8Encode()).AsUInt64();
            }
        }
        int refCount = 0;
        public IntPtr dbPtr;
